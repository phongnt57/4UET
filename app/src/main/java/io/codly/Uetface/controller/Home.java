...
import slidingmenu.NavDrawerListAdapter;
import slidingmenu.*;
...
public class Home extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getActionBar().setCustomView(R.layout.actionbar_textcenter);
        //setTitle("Hello");
       ...
       // navDrawerItems.add(new NavDrawerItem(navMenuTitles[5], navMenuIcons.getResourceId(5, -1), true, "50+"));
        ...
        //getSupportActionBar().setBackgroundDrawable(new ColorDrawable("#85C75B"));
